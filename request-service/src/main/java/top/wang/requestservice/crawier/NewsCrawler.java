package top.wang.requestservice.crawier;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://www.zhihu.com/billboard";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"root\"]/div/main/div/a/div[2]/div[1]");
                    //*[@id="root"]/div/main/div/a[2]/div[2]/div[1]
                    //*[@id="root"]/div/main/div/a[1]/div[2]/div[1]
                    System.out.println(titleNodes.length);
                    // 6. 输出结果
                    System.out.println("----- 知乎热榜 -----");
